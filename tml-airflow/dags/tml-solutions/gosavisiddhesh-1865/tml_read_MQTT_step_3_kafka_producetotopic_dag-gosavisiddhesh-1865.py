...
default_args = {
  ...
  'mqtt_broker' : '727ca55bb60243ff8b897de7ca740e0e.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_gosavisiddhesh-1865", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_gosavisiddhesh-1865"], schedule=None,catchup=False)
