...
step3 = importlib.import_module("tml-solutions.myfirsttssproject3-1865.tml_read_MQTT_step_3_kafka_producetotopic_dag-myfirsttssproject3-1865")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_mqtt_dag-myfirsttssproject3-1865",
